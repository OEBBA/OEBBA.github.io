...
$(document).ready((function() {
    ...
    /* SCROLL SHOW/HIDE FOR PROJECTS*/
     ...
     if ($(this).scrollTop() > 1200) {
       ...
       setTimeout(function(){
         $('#projectCard4').addClass('fadeIn');
        if($( "#projectCard4" ).hasClass( "invisible" )){
    $('#projectCard4').removeClass('invisible');
    console.log("Removing Invisible");
    $('#projectCard4').addClass('visible');
   };
 }, 450);

 setTimeout(function(){
   $('#projectCard5').addClass('fadeIn');
  if($( "#projectCard5" ).hasClass( "invisible" )){
$('#projectCard5').removeClass('invisible');
console.log("Removing Invisible");
$('#projectCard5').addClass('visible');
};
}, 600);

setTimeout(function(){
  $('#projectCard6').addClass('fadeIn');
 if($( "#projectCard6" ).hasClass( "invisible" )){
$('#projectCard6').removeClass('invisible');
console.log("Removing Invisible");
$('#projectCard6').addClass('visible');
};
}, 750);
...
$('#projectCard9').addClass('visible');
	...
	if ($(this).scrollTop() < 1200) {
       ...
       setTimeout(function(){
   			$('#projectCard4').removeClass('fadeIn');
      }, 450);
      setTimeout(function(){
  			$('#projectCard5').removeClass('fadeIn');
      }, 600);
      setTimeout(function(){
